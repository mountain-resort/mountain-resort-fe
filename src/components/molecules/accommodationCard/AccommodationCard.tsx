...
const styles = {
  ...
  buttonContainer: 'flex justify-center items-center w-full space-x-4 pc:space-x-7 mt-5 pc:mt-6',
  separatorLine: 'border-t-2 border-primary-gold border-solid w-[51px] hidden pc:block',
  buttonStyles: 'h-[35px] pc:h-[43px] text-[14px]',
};

const AccommodationCard = ({ name, description, images }: AccommodationCardProps) => {
  const imageSrc = images[0] ?? assets.images.accommodation01FamilyFriendlyCabin;
    ...
    <div className={styles.card}>
      ...
      <div className={styles.content}>
        ...
        <div className={styles.buttonContainer}>
          ...
          <Button variant="primary" className={`${styles.buttonStyles} hidden pc:flex`}>
            CHECK RATE
          </Button>
        </div>
      </div>
